    ...
    b.VERSION = "1.6.0", b.DEFAULTS = {
        ...
        createLi: function() {
            ...
            return this.$element.find("option").each(function() {
                ...
                else if (d.parent().is("optgroup") && d.data("divider") !== !0) if (0 === d.index()) {
                ...
                if (b.multiple && c.stopPropagation(), c.preventDefault(), !b.isDisabled() && !a(this).parent().hasClass("disabled")) {
                    ...
                    if (b.multiple) {
                        if (h.prop("selected", !i), b.setSelected(d, !i), a(this).blur(), k !== !1 || l !== !1) {
                            ...
                            if (k && m || l && n) if (k && 1 == k) g.prop("selected", !1), h.prop("selected", !0), b.$menu.find(".selected").removeClass("selected"), b.setSelected(d, !0);
                            else if (l && 1 == l) {
